...
class MainWindow(QMainWindow):
    def __init__(self, Status):
        ...
        # Populate the Functional and Performance QMainWidget with pages Objectives and criteria
        self.populate_with_objective_pages(objectives)
        self.populate_with_criterion_pages(criteria, metrics, metric_options)
        
        # Populate the Functional_MainWidget with the answers in the database
        if Status == "New":
